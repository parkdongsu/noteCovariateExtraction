...
#' @param noteConceptId,existingTopicModel,topicModelExportRds,useDictionary,limitedMedicalTermOnlyLanguage,nGram,buildTopidModelMinFrac,buildTopidModelMaxFrac,optimalTopicValue,numberOfTopics,sampleSize
#' @keywordsa createCovariateSetting
#' @export
#' @examples
#' createLoadingDefaultTopicModelSetting()
createLoadingDefaultTopicModelSetting <- function(noteConceptId = c(44814637),
